...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        addTaskButton->setGeometry(QRect(560, 50, 111, 23));
        addTaskInput = new QLineEdit(centralwidget);
        addTaskInput->setObjectName("addTaskInput");
        addTaskInput->setGeometry(QRect(40, 50, 491, 23));
        TaskList = new QListWidget(centralwidget);
        TaskList->setObjectName("TaskList");
        TaskList->setGeometry(QRect(40, 90, 571, 401));
